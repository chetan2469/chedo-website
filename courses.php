...
<div class="card card-hover relative p-6">
  ...
  <p class="mt-2 text-sm leading-relaxed text-slate-600">Start with C Programming or Python Programming. C builds rock-solid logic from zero; Python gets you writing useful code quickly.</p>
  <p class="mt-3 text-sm"><a class="font-semibold text-blue-700 hover:underline" href="courses/c-programming.php">C Programming</a> · <a class="font-semibold text-blue-700 hover:underline" href="courses/python-programming.php">Python Programming</a></p>
</div>
<div class="card card-hover relative p-6">
