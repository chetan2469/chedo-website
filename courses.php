    ...
    <nav class="hidden items-center gap-0.5 lg:flex" aria-label="Main navigation">
      ...
      <div class="dropdown relative" id="courses-drop">
        ...
        <div class="dropdown-panel" role="menu" aria-label="Courses">
          <div class="grid grid-cols-2 gap-x-4 gap-y-3"><div><p class="drop-head">Programming</p><div class="grid gap-0.5"><a class="dropdown-link font-semibold text-orange-700 animate-fade-in" href="courses/java-dsa.php"><span class="drop-icon bg-orange-50 text-orange-600"><svg aria-hidden="true" focusable="false" class="h-[18px] w-[18px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></span><span class="text-sm font-semibold text-orange-700">Java + DSA <span class="ml-1 rounded bg-orange-100 px-1 py-0.5 text-[9px] font-bold uppercase text-orange-800">New</span></span></a><a class="dropdown-link font-semibold text-blue-700 animate-fade-in" href="courses/python-dsa.php"><span class="drop-icon bg-yellow-50 text-blue-600 border border-yellow-200"><svg aria-hidden="true" focusable="false" class="h-[18px] w-[18px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></span><span class="text-sm font-semibold text-blue-700">Python + DSA <span class="ml-1 rounded bg-yellow-100 px-1 py-0.5 text-[9px] font-bold uppercase text-yellow-800">New</span></span></a><a class="dropdown-link font-semibold text-blue-700 animate-fade-in" href="courses/c-cpp-dsa.php"><span class="drop-icon bg-blue-50 text-blue-600"><svg aria-hidden="true" focusable="false" class="h-[18px] w-[18px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></span><span class="text-sm font-semibold text-blue-700">C + C++ + DSA <span class="ml-1 rounded bg-blue-100 px-1 py-0.5 text-[9px] font-bold uppercase text-blue-800">New</span></span></a><a class="dropdown-link" href="courses/c-programming.php"><span class="drop-icon"><!-- @license lucide-static v1.28.0 - ISC -->
...
<section class="relative overflow-hidden border-b border-slate-100">
  ...
  <div class="relative mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-8 lg:pb-20 lg:pt-16">
    <nav aria-label="Breadcrumb" class="mb-6"><ol class="flex flex-wrap items-center gap-2 text-sm text-slate-500"><li><a class="transition-colors hover:text-blue-700" href="index.php">Home</a></li><li class="text-slate-300" aria-hidden="true">/</li><li class="text-slate-600" aria-current="page">Courses</li></ol></nav>
    <div class="max-w-3xl">
      <p class="eyebrow">// COURSE CATALOG</p>
      <h1 class="mt-3 text-[clamp(2.2rem,5vw,3.75rem)] font-extrabold leading-[1.06] tracking-tight text-slate-900">Courses Built Around<br><span class="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Real Practice.</span></h1>
      <p class="mt-5 max-w-2xl text-lg leading-relaxed text-slate-600">
        You can start your programming career with zero knowledge of coding. Every course here takes you
        from fundamentals to building real projects — taught offline, in person, in Pune.
      </p>
...
>
 ...
 Offline classroom training</span>
        <span class="chip-tint"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-3.5 w-3.5"
  xmlns="http://www.w3.org/2000/svg"
...
>
 ...
 Project based</span>
    ...
    <nav class="mt-10 flex flex-wrap gap-2" aria-label="Course categories">
      <a class="chip transition-colors hover:border-blue-300 hover:text-blue-700" href="#group-programming">Programming Courses</a><a class="chip transition-colors hover:border-blue-300 hover:text-blue-700" href="#group-development">Development Courses</a><a class="chip transition-colors hover:border-blue-300 hover:text-blue-700" href="#group-data-ai">Data & AI Courses</a><a class="chip transition-colors hover:border-blue-300 hover:text-blue-700" href="#group-design">Design</a><a class="chip transition-colors hover:border-blue-300 hover:text-blue-700" href="#group-kids">Kids Programming</a>
    </nav>
  </div>
</section>
...
<section class="scroll-mt-24 py-10" id="group-programming">
  ...
  <div class="mb-7 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <h2 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Programming Courses</h2>
      <p class="mt-1.5 max-w-xl text-[15px] text-slate-500">Languages that build your logic and fundamentals — the right place to start.</p>
    </div>
  </div>
  <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
<article class="card card-hover flex flex-col p-6 border-orange-100 bg-gradient-to-br from-orange-50/10 to-amber-50/5" data-category="programming">
...
<article class="card card-hover flex flex-col p-6 border-blue-100 bg-gradient-to-br from-blue-50/10 to-yellow-50/5" data-category="programming">
  <div class="flex items-center justify-between">
...
<article class="card card-hover flex flex-col p-6 border-blue-100 bg-gradient-to-br from-blue-50/10 to-indigo-50/5" data-category="programming">
  <div class="flex items-center justify-between">
...
<article class="card card-hover flex flex-col p-6 " data-category="programming">
  <div class="flex items-center justify-between">
...
<section class="scroll-mt-24 py-10" id="group-development">
  ...
  <div class="mb-7 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <h2 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Development Courses</h2>
      <p class="mt-1.5 max-w-xl text-[15px] text-slate-500">Complete stacks for building real applications — web and mobile.</p>
    </div>
  </div>
  <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
<article class="card card-hover flex flex-col p-6 " data-category="full-stack">
  <div class="flex items-center justify-between">
    <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-6 w-6"
...
<article class="card card-hover flex flex-col p-6 " data-category="mobile">
  <div class="flex items-center justify-between">
    <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-6 w-6"
...
<section class="scroll-mt-24 py-10" id="group-data-ai">
  ...
  <div class="mb-7 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <h2 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Data & AI Courses</h2>
      <p class="mt-1.5 max-w-xl text-[15px] text-slate-500">From data basics to machine learning, statistics and Power BI.</p>
    </div>
  </div>
  <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
<article class="card card-hover flex flex-col p-6 " data-category="data-ai">
  <div class="flex items-center justify-between">
    <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-6 w-6"
...
<section class="scroll-mt-24 py-10" id="group-design">
  ...
  <div class="mb-7 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <h2 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Design</h2>
      <p class="mt-1.5 max-w-xl text-[15px] text-slate-500">Interfaces, brands and design systems with modern AI-powered tools.</p>
    </div>
  </div>
  <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
<article class="card card-hover flex flex-col p-6 " data-category="design">
  <div class="flex items-center justify-between">
    <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-6 w-6"
...
<section class="scroll-mt-24 py-10" id="group-kids">
  ...
  <div class="mb-7 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <h2 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Kids Programming</h2>
      <p class="mt-1.5 max-w-xl text-[15px] text-slate-500">Step-by-step coding for ages 7–16 — fun, practical and confidence-building.</p>
    </div>
  </div>
  <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
<article class="card card-hover flex flex-col p-6 " data-category="kids">
  <div class="flex items-center justify-between">
    <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-6 w-6"
...
<div class="mx-auto text-center max-w-3xl">
  ...
  <h2 class="mt-3 text-[clamp(1.9rem,4vw,3.25rem)] font-extrabold leading-[1.12] tracking-tight text-slate-900">Not Sure Where to Start?</h2>
  <p class="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Three common starting points — pick the one that matches your goal.</p>
</div>

    <div class="mt-10 grid gap-5 md:grid-cols-3">
<div class="card card-hover relative p-6">
  <span class="font-mono text-xs font-bold text-blue-600">PATH 1</span>
  <h3 class="mt-2 text-lg font-bold tracking-tight text-slate-900">Completely new to programming</h3>
  <p class="mt-2 text-sm leading-relaxed text-slate-600">Start with our Java + DSA, Python + DSA, or C + C++ + DSA Foundation courses (recommended) for strong logic and coding interviews. Or choose Python or C Programming.</p>
  <p class="mt-3 text-sm"><a class="font-semibold text-blue-700 hover:underline" href="courses/java-dsa.php">Java + DSA</a> &middot; <a class="font-semibold text-blue-700 hover:underline" href="courses/python-dsa.php">Python + DSA</a> &middot; <a class="font-semibold text-blue-700 hover:underline" href="courses/c-cpp-dsa.php">C + C++ + DSA</a></p>
</div>
<div class="card card-hover relative p-6">
  <span class="font-mono text-xs font-bold text-blue-600">PATH 2</span>
  <h3 class="mt-2 text-lg font-bold tracking-tight text-slate-900">Want to build websites or apps</h3>
  <p class="mt-2 text-sm leading-relaxed text-slate-600">Go straight into MERN Full Stack, Java Full Stack or Mobile App Development — they begin with the fundamentals.</p>
  <p class="mt-3 text-sm"><a class="font-semibold text-blue-700 hover:underline" href="courses/mern-full-stack.php">MERN Full Stack Development</a> · <a class="font-semibold text-blue-700 hover:underline" href="courses/java-full-stack.php">Java Full Stack Development</a> · <a class="font-semibold text-blue-700 hover:underline" href="courses/mobile-app-development.php">Mobile App Development (Flutter)</a></p>
</div>
<div class="card card-hover relative p-6">
  <span class="font-mono text-xs font-bold text-blue-600">PATH 3</span>
  <h3 class="mt-2 text-lg font-bold tracking-tight text-slate-900">Curious about data and AI</h3>
  <p class="mt-2 text-sm leading-relaxed text-slate-600">Start with Data Science Foundation (no coding needed), then move into the complete Data Science program.</p>
  <p class="mt-3 text-sm"><a class="font-semibold text-blue-700 hover:underline" href="courses/data-science-foundation.php">Data Science Foundation</a> · <a class="font-semibold text-blue-700 hover:underline" href="courses/data-science.php">Data Science</a></p>
</div></div>
    <p class="mt-8 text-center text-[15px] text-slate-600">Still not sure? <a class="font-semibold text-blue-700 hover:underline" href="contact.php">Talk with us</a> — we will help you choose.</p>
  </div>
</section>
...
<div class="mx-auto text-center max-w-3xl">
  ...
  <h2 class="mt-3 text-[clamp(1.9rem,4vw,3.25rem)] font-extrabold leading-[1.12] tracking-tight text-slate-900">Enrolling Is Simple.</h2>
  <p class="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Join Chedo Tech and master programming through fully offline, personalized training with real-world applications.</p>
</div>

    <ol class="mt-10 grid gap-5 md:grid-cols-3"><li class="card relative p-6">
      <span class="inline-flex items-center justify-center rounded-lg bg-blue-50 px-2.5 py-1 font-mono text-sm font-extrabold text-blue-700" aria-hidden="true">01</span>
      <h3 class="mt-2 flex items-center gap-2 text-[15px] font-bold text-slate-900"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
 ...
 Choose Your Course</h3>
      <p class="mt-2 text-sm leading-relaxed text-slate-600">Browse from our range of offline courses — C, Python, Java, Full Stack, Data Science, Mobile App Development, and more.</p>
    </li><li class="card relative p-6">
      <span class="inline-flex items-center justify-center rounded-lg bg-blue-50 px-2.5 py-1 font-mono text-sm font-extrabold text-blue-700" aria-hidden="true">02</span>
      <h3 class="mt-2 flex items-center gap-2 text-[15px] font-bold text-slate-900"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4 text-blue-600"
  xmlns="http://www.w3.org/2000/svg"
...
>
 ...
 Plan & Enroll Offline</h3>
      <p class="mt-2 text-sm leading-relaxed text-slate-600">Meet us in person, plan your curriculum, and enroll directly at our center. Get study material, notes, and a learning schedule.</p>
    </li><li class="card relative p-6">
      <span class="inline-flex items-center justify-center rounded-lg bg-blue-50 px-2.5 py-1 font-mono text-sm font-extrabold text-blue-700" aria-hidden="true">03</span>
      <h3 class="mt-2 flex items-center gap-2 text-[15px] font-bold text-slate-900"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4 text-blue-600"
  xmlns="http://www.w3.org/2000/svg"
...
>
 ...
 Attend, Learn & Build Projects</h3>
      <p class="mt-2 text-sm leading-relaxed text-slate-600">Learn practically through hands-on coding, offline mentoring, whiteboard teaching, and real project building. No screen-sharing — real learning.</p>
    </li></ol>
  </div>
</section>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    <div class="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-6 py-14 text-center sm:px-12 sm:py-16">
      ...
      <div class="relative">
        <h2 class="mx-auto max-w-2xl text-[clamp(1.9rem,4vw,3rem)] font-extrabold leading-tight tracking-tight text-slate-900">Pick a Course and Start Building.</h2>
        <p class="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-slate-600">Browse the catalog above — or talk with us first. We will help you plan your curriculum and learning schedule.</p>
        <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a class="btn-primary btn-lg" href="#group-programming">Browse Courses</a>
