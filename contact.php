...
<section class="relative overflow-hidden border-b border-slate-100">
  ...
  <div class="relative mx-auto max-w-7xl px-5 pb-14 pt-14 sm:px-8 lg:pb-16 lg:pt-16">
    <nav aria-label="Breadcrumb" class="mb-6"><ol class="flex flex-wrap items-center gap-2 text-sm text-slate-500"><li><a class="transition-colors hover:text-blue-700" href="index.php">Home</a></li><li class="text-slate-300" aria-hidden="true">/</li><li class="text-slate-600" aria-current="page">Contact</li></ol></nav>
    <div class="max-w-3xl">
      <p class="eyebrow">// CONTACT &amp; ENQUIRY</p>
      <h1 class="mt-3 text-[clamp(2.2rem,5vw,3.75rem)] font-extrabold leading-[1.06] tracking-tight text-slate-900">Talk With Us.</h1>
...
<div class="card p-6">
  <div class="flex items-center gap-3">
    <span class="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  ...
  <a class="btn-secondary mt-4 w-full" href="mailto:chedotech@gmail.com" data-email-link>Send an Email</a>
    ...
    <div class="lg:col-span-7">
      <div class="card p-7 sm:p-9">
        <p class="font-mono text-[11px] font-bold tracking-widest text-blue-600">// ENQUIRY FORM</p>
        <h2 class="mt-2 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Send Us an Enquiry</h2>
        ...
        <form id="enquiry-form" method="post" action="/enquire-submit.php" class="mt-7 grid gap-5 sm:grid-cols-2" novalidate>
          <div>
          ...
          <div class="sm:col-span-2">
            ...
            <textarea class="field-input" id="f-message" name="message" rows="4" placeholder="Tell us your background or goals (optional)"></textarea>
          </div>
          <div class="sm:col-span-2">
...
<section class="py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    <div class="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-6 py-14 text-center sm:px-12 sm:py-16">
      ...
      <div class="relative">
        <h2 class="mx-auto max-w-2xl text-[clamp(1.9rem,4vw,3rem)] font-extrabold leading-tight tracking-tight text-slate-900">Prefer to Talk in Person?</h2>
        <p class="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-slate-600">Visit the center to plan your curriculum, get study material and enroll directly with a learning schedule.</p>
