...
<head>
  ...
  <title>Java Programming Course in Pune | Chedo Tech</title>
  <meta name="description" content="Learn Java programming in Pune at Chedo Tech — offline, practical classes covering OOP, inheritance, interfaces, exception handling, AWT GUI and algorithms.">
  <link rel="canonical" href="https://chedo.in/courses/java-programming.php">
  <link rel="icon" type="image/png" href="../assets/logo.png">
  <link rel="apple-touch-icon" href="../assets/logo.png">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Chedo Tech">
  <meta property="og:title" content="Java Programming Course in Pune | Chedo Tech">
  <meta property="og:description" content="Learn Java programming in Pune at Chedo Tech — offline, practical classes covering OOP, inheritance, interfaces, exception handling, AWT GUI and algorithms.">
  <meta property="og:url" content="https://chedo.in/courses/java-programming.html">
  <meta property="og:image" content="https://chedo.in/assets/images/og-image.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Java Programming Course in Pune | Chedo Tech">
  <meta name="twitter:description" content="Learn Java programming in Pune at Chedo Tech — offline, practical classes covering OOP, inheritance, interfaces, exception handling, AWT GUI and algorithms.">
  <meta name="twitter:image" content="https://chedo.in/assets/images/og-image.png">
  <link rel="preload" href="../assets/fonts/inter-latin.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="stylesheet" href="../assets/css/main.css">
  <script defer src="../assets/js/config.js"></script>
  <script defer src="../assets/js/main.js"></script>
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Course", "name": "Java Programming", "description": "Learn Java programming in Pune at Chedo Tech — offline, practical classes covering OOP, inheritance, interfaces, exception handling, AWT GUI and algorithms.", "url": "https://chedo.in/courses/java-programming.html", "provider": {"@type": "EducationalOrganization", "name": "Chedo Tech", "url": "https://chedo.in/"}, "inLanguage": "en", "courseMode": "Offline"}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://chedo.in/"}, {"@type": "ListItem", "position": 2, "name": "Courses", "item": "https://chedo.in/courses.html"}, {"@type": "ListItem", "position": 3, "name": "Java Programming", "item": "https://chedo.in/courses/java-programming.html"}]}</script></head>
  ...
  <div class="relative mx-auto max-w-7xl px-5 pb-16 pt-12 sm:px-8 lg:pb-20 lg:pt-14">
    ...
    <div class="grid items-start gap-10 lg:grid-cols-12">
      <div class="lg:col-span-8">
        ...
        <h1 class="mt-5 text-[clamp(2.2rem,5vw,3.75rem)] font-extrabold leading-[1.06] tracking-tight text-slate-900">Java Programming</h1>
        <p class="mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Master Java foundations — OOP, interfaces, exceptions, GUI and algorithms.</p>
        <div class="mt-7 flex flex-col gap-3 sm:flex-row">
          <a class="btn-wa" data-wa data-wa-text="Hello Chedo Tech, I am interested in the Java Programming course. Please share more information." href="../contact.php">
            <!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
...
>
  <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0 1 20 4v10a1 1 0 0 1-.4.8A6 6 0 0 1 16 16c-3 0-5-2-8-2a6 6 0 0 0-4 1.528" />
          ...
          <a class="btn-primary mt-6 w-full" data-wa data-wa-text="Hello Chedo Tech, I am interested in the Java Programming course. Please share more information." href="../contact.php">Get Course Details</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-2">
    <div>
      ...
      <div class="mt-5 space-y-4"><p class="leading-relaxed text-slate-600">Java is one of the most widely used languages in the world, and this course builds its foundations properly: syntax, operators, control flow, strings, methods, constructors and static features first — then the OOP core of Java: inheritance, abstraction, polymorphism, interfaces, packages and access control.</p><p class="leading-relaxed text-slate-600">You also get exception handling, GUI programming with Applets and AWT (including event handling), file handling and sorting algorithms — taught offline with live coding and practice programs at every step.</p></div>
    </div>
    <div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Deep OOP practice</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Inheritance, abstraction, polymorphism, interfaces and packages — Java's OOP model in full.</p></div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Industry-standard language</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Java powers enterprise backends, Android and large-scale systems.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Clean, strict language</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Type safety and strong structure make Java an excellent language for building discipline.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Path to full stack</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">This course is the direct foundation for our Java Full Stack Development program.</p></div>
    </li></ul>
    </div>
  </div>
</section>
...
<details class="acc-item" open>
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Basics &amp; Fundamentals</span>
      <span class="block text-xs font-medium text-slate-500">First programs</span>
    </span>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Introduction &amp; Basic Syntax</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Structure of a Java program</p>
        </div>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Scanner Input</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Reading user input</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Operators &amp; Wrapper Classes</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Working with values and objects</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Naming Conventions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Clean, standard code style</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Control Flow &amp; Strings</span>
      <span class="block text-xs font-medium text-slate-500">Decisions, loops, text</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Conditional Statements</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Practice on if-else and switch logic</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Strings</p>
          <p class="text-[13px] leading-relaxed text-slate-500">String methods and manipulation</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">StringBuilder</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Efficient string handling</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Methods &amp; Static Features</span>
      <span class="block text-xs font-medium text-slate-500">Reusable behavior</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Methods</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Parameters, return values</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">Object initialization</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">this Keyword &amp; Method Overloading</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Polymorphism at compile time</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Static Variables &amp; Methods</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Class-level members</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Inheritance &amp; Abstraction</span>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Inheritance Types</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Single, multilevel, hierarchical</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">super Keyword</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Accessing parent members</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Abstraction</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Abstract methods and classes</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Anonymous Classes</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Inline class behavior</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Polymorphism &amp; Overriding</span>
      <span class="block text-xs font-medium text-slate-500">Runtime behavior</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Method Overriding</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Redefining behavior in subclasses</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Overriding vs Overloading</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Know the difference</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">final Keyword</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Preventing change</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Interfaces &amp; Access Control</span>
      <span class="block text-xs font-medium text-slate-500">Contracts and visibility</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Interfaces</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Defining contracts</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Packages</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Organizing Java code</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">public, private, protected</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      ...
      <span class="block text-xs font-medium text-slate-500">Reliable programs</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Exception Basics</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Handling runtime errors</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Checked &amp; Unchecked Exceptions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Compile-time vs runtime</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Custom Exceptions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Your own exception types</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">GUI &amp; Algorithms</span>
      <span class="block text-xs font-medium text-slate-500">Visual programs + logic</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Applets</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Java in the browser (classic GUI)</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">AWT &amp; Event Handling</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Windows, components, events</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">File Handling</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Read/write files</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Bubble Sort Algorithm</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Your first sorting algorithm</p>
        </div>
      </li></ul>
  </div>
</details></div>
...
<section class="border-t border-slate-100 bg-slate-50/70 py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    ...
    <div class="mt-6 flex flex-wrap gap-2"><span class="chip">OOP in Java</span><span class="chip">Inheritance &amp; Interfaces</span><span class="chip">Exception Handling</span><span class="chip">Static &amp; Instance Members</span><span class="chip">GUI with AWT</span><span class="chip">File Handling</span><span class="chip">Sorting Algorithms</span></div>
  </div>
</section>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Console Applications</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Complete programs combining classes, methods and control flow.</p>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Inheritance, abstraction and interface-based designs.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">AWT GUI Programs</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Windows and event handling with the Abstract Window Toolkit.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">File Handling Programs</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Reading and writing data to files.</p>
    </div></div>
  </div>
</section>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    <div class="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-6 py-14 text-center sm:px-12 sm:py-16">
      ...
      <div class="relative">
        <h2 class="mx-auto max-w-2xl text-[clamp(1.9rem,4vw,3rem)] font-extrabold leading-tight tracking-tight text-slate-900">Interested in the Java Programming Course?</h2>
        ...
        <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a class="btn-wa btn-lg" data-wa data-wa-text="Hello Chedo Tech, I am interested in the Java Programming course. Please share more information." href="../contact.php"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
