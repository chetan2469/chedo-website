...
<head>
  ...
  <meta property="og:description" content="Learn Data Structures &amp; Algorithms in Pune at Chedo Tech — arrays, linked lists, stacks, queues, searching, sorting, trees and graphs with hands-on implementation practice.">
  <meta property="og:url" content="https://chedo.in/courses/data-structures-algorithms.html">
  <meta property="og:image" content="https://chedo.in/assets/images/og-image.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Data Structures &amp; Algorithms Course in Pune | Chedo Tech">
  <meta name="twitter:description" content="Learn Data Structures &amp; Algorithms in Pune at Chedo Tech — arrays, linked lists, stacks, queues, searching, sorting, trees and graphs with hands-on implementation practice.">
  <meta name="twitter:image" content="https://chedo.in/assets/images/og-image.png">
  <link rel="preload" href="../assets/fonts/inter-latin.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="stylesheet" href="../assets/css/main.css">
  <script defer src="../assets/js/config.js"></script>
  <script defer src="../assets/js/main.js"></script>
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Course", "name": "Data Structures & Algorithms", "description": "Learn Data Structures & Algorithms in Pune at Chedo Tech — arrays, linked lists, stacks, queues, searching, sorting, trees and graphs with hands-on implementation practice.", "url": "https://chedo.in/courses/data-structures-algorithms.html", "provider": {"@type": "EducationalOrganization", "name": "Chedo Tech", "url": "https://chedo.in/"}, "inLanguage": "en", "courseMode": "Offline"}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://chedo.in/"}, {"@type": "ListItem", "position": 2, "name": "Courses", "item": "https://chedo.in/courses.html"}, {"@type": "ListItem", "position": 3, "name": "Data Structures & Algorithms", "item": "https://chedo.in/courses/data-structures-algorithms.html"}]}</script></head>
  ...
  <div class="relative mx-auto max-w-7xl px-5 pb-16 pt-12 sm:px-8 lg:pb-20 lg:pt-14">
    ...
    <div class="grid items-start gap-10 lg:grid-cols-12">
      <div class="lg:col-span-8">
        ...
        <h1 class="mt-5 text-[clamp(2.2rem,5vw,3.75rem)] font-extrabold leading-[1.06] tracking-tight text-slate-900">Data Structures &amp; Algorithms</h1>
        <p class="mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Comprehensive DSA — arrays, linked lists, stacks, queues, searching, sorting, trees and graphs.</p>
        <div class="mt-7 flex flex-col gap-3 sm:flex-row">
          <a class="btn-wa" data-wa data-wa-text="Hello Chedo Tech, I am interested in the Data Structures &amp; Algorithms course. Please share more information." href="../contact.php">
            <!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
...
>
  <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0 1 20 4v10a1 1 0 0 1-.4.8A6 6 0 0 1 16 16c-3 0-5-2-8-2a6 6 0 0 0-4 1.528" />
          ...
          <a class="btn-primary mt-6 w-full" data-wa data-wa-text="Hello Chedo Tech, I am interested in the Data Structures &amp; Algorithms course. Please share more information." href="../contact.php">Get Course Details</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-2">
    <div>
      ...
      <div class="mt-5 space-y-4"><p class="leading-relaxed text-slate-600">Data Structures & Algorithms is the subject that turns code into efficient software — and the foundation of technical interviews. This course covers the full spectrum: from arrays and linked lists to stacks, queues, searching, sorting, trees and graphs.</p><p class="leading-relaxed text-slate-600">Each structure is studied in depth — including advanced variants like circular and double-ended queues, AVL, red-black and B-trees, and graph algorithms like Dijkstra's and Floyd-Warshall — with implementations practiced in class.</p></div>
    </div>
    <div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Interview preparation</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Technical interviews are built on DSA — this is the course that prepares you for them.</p></div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Efficient thinking</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Learn time complexity and choose the right structure for the right problem.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Deep, not shallow</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Full coverage of variants: circular lists, priority queues, balanced trees, MST algorithms.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Foundation for everything</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">DSA strengthens your C, C++, Java and Python work and your full-stack career.</p></div>
    </li></ul>
    </div>
  </div>
</section>
...
<details class="acc-item" open>
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Fundamentals</span>
      <span class="block text-xs font-medium text-slate-500">The building blocks</span>
    </span>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Arrays</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Static, dynamic, multi-dimensional</p>
        </div>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Pointers</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Memory and access</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Memory Allocation</p>
          <p class="text-[13px] leading-relaxed text-slate-500">How structures live in memory</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Linked Lists</span>
      <span class="block text-xs font-medium text-slate-500">Nodes and links</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Singly Linked List</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Traversal, insertion, deletion</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Singly Circular List</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Circular traversal</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Doubly Linked List</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Two-way navigation</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Doubly Circular List</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Full circularity</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Stack</span>
      <span class="block text-xs font-medium text-slate-500">LIFO structures</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Static Stack</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Fixed-size implementation</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Dynamic Stack</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Growable implementation</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">push, pop, peek</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Core operations</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Expression Evaluation</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Infix to Postfix conversion</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Queue</span>
      <span class="block text-xs font-medium text-slate-500">FIFO structures</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Static &amp; Static Circular Queue</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Array-based queues</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Dynamic &amp; Dynamic Circular Queue</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Growable queues</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Double-Ended Queue</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Deque, both ends</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Priority Queue</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Ordered processing</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Searching</span>
      <span class="block text-xs font-medium text-slate-500">Finding data</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Linear Search</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Simple sequential search</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Binary Search</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Fast sorted search</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Time Complexity</p>
...
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Sorting</span>
      <span class="block text-xs font-medium text-slate-500">Ordering data</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Bubble &amp; Insertion Sort</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Simple sorts</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Selection Sort</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Selection-based sorting</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Merge &amp; Quick Sort</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Divide and conquer</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Heap, Counting, Radix Sort</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Advanced sorting</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Trees</span>
      <span class="block text-xs font-medium text-slate-500">Hierarchical data</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Binary Tree &amp; BST</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Structure and properties</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">AVL &amp; Red-Black Trees</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Self-balancing trees</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">B-Tree</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Multi-way search trees</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Segment &amp; Fenwick Trees</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Range queries</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Traversal &amp; Balancing</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Ordering and stability</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Graphs</span>
      <span class="block text-xs font-medium text-slate-500">Networks and paths</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Adjacency Matrix &amp; List</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Graph representations</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">BFS &amp; DFS</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Graph traversal</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">MST — Prim's &amp; Kruskal's</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Minimum spanning trees</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Dijkstra's &amp; Bellman-Ford</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Shortest paths</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Floyd-Warshall</p>
          <p class="text-[13px] leading-relaxed text-slate-500">All-pairs shortest paths</p>
        </div>
      </li></ul>
  </div>
</details></div>
...
<section class="border-t border-slate-100 bg-slate-50/70 py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    ...
    <div class="mt-6 flex flex-wrap gap-2"><span class="chip">Data Structure Design</span><span class="chip">Algorithm Implementation</span><span class="chip">Time &amp; Space Complexity</span><span class="chip">Problem Solving</span><span class="chip">Interview Preparation</span><span class="chip">Optimized Code</span></div>
  </div>
</section>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Structure Implementations</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Stacks, queues, lists and trees built from scratch.</p>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Sorting &amp; Searching Programs</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Algorithms implemented and compared.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Graph Algorithms</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">BFS, DFS, MST and shortest path programs.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Interview Practice Sets</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">DSA problems solved in class and at home.</p>
    </div></div>
  </div>
</section>
...
>
  ...
  <h3 class="mt-4 text-base font-bold tracking-tight text-slate-900">C Programming</h3>
  <p class="mt-2 flex-1 text-sm leading-relaxed text-slate-500">Variables, data types, operators, input/output. Control structures: if-else, loops, switch. Functions, recursion, pointers. Arrays, strings, structures. File handling, dynamic memory.</p>
  <a class="arrow-link mt-4" href="../courses/c-programming.php">Explore Course <span class="arrow"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
...
>
  ...
  <h3 class="mt-4 text-base font-bold tracking-tight text-slate-900">C++ Programming</h3>
  <p class="mt-2 flex-1 text-sm leading-relaxed text-slate-500">Fundamentals, OOP with classes &amp; objects, inheritance, polymorphism. Functions, templates, STL. Pointers, references, exception handling. File I/O, memory management.</p>
  <a class="arrow-link mt-4" href="../courses/cpp-programming.php">Explore Course <span class="arrow"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
...
>
  ...
  <h3 class="mt-4 text-base font-bold tracking-tight text-slate-900">Java Programming</h3>
  <p class="mt-2 flex-1 text-sm leading-relaxed text-slate-500">Data types, object literals, operators, modifiers, variables, methods, control flow statements, exception handling, static &amp; instance members, OOP, Applet, AWT, event handling, file handling.</p>
  <a class="arrow-link mt-4" href="../courses/java-programming.php">Explore Course <span class="arrow"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
...
<section class="py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    <div class="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-6 py-14 text-center sm:px-12 sm:py-16">
      ...
      <div class="relative">
        <h2 class="mx-auto max-w-2xl text-[clamp(1.9rem,4vw,3rem)] font-extrabold leading-tight tracking-tight text-slate-900">Interested in the Data Structures & Algorithms Course?</h2>
        ...
        <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a class="btn-wa btn-lg" data-wa data-wa-text="Hello Chedo Tech, I am interested in the Data Structures &amp; Algorithms course. Please share more information." href="../contact.php"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
