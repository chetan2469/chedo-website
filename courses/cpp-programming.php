...
<head>
  ...
  <title>C++ Programming Course in Pune | Chedo Tech</title>
  <meta name="description" content="Learn C++ programming in Pune at Chedo Tech — offline classes covering OOP, memory management, templates, STL, exceptions and file handling with practical programs.">
  <link rel="canonical" href="https://chedo.in/courses/cpp-programming.php">
  <link rel="icon" type="image/svg+xml" href="../assets/images/favicon.svg">
  <link rel="apple-touch-icon" href="../assets/images/apple-touch-icon.png">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Chedo Tech">
  <meta property="og:title" content="C++ Programming Course in Pune | Chedo Tech">
  <meta property="og:description" content="Learn C++ programming in Pune at Chedo Tech — offline classes covering OOP, memory management, templates, STL, exceptions and file handling with practical programs.">
  <meta property="og:url" content="https://chedo.in/courses/cpp-programming.html">
  <meta property="og:image" content="https://chedo.in/assets/images/og-image.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="C++ Programming Course in Pune | Chedo Tech">
  <meta name="twitter:description" content="Learn C++ programming in Pune at Chedo Tech — offline classes covering OOP, memory management, templates, STL, exceptions and file handling with practical programs.">
  <meta name="twitter:image" content="https://chedo.in/assets/images/og-image.png">
  <link rel="preload" href="../assets/fonts/inter-latin.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="stylesheet" href="../assets/css/main.css">
  <script defer src="../assets/js/config.js"></script>
  <script defer src="../assets/js/main.js"></script>
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Course", "name": "C++ Programming", "description": "Learn C++ programming in Pune at Chedo Tech — offline classes covering OOP, memory management, templates, STL, exceptions and file handling with practical programs.", "url": "https://chedo.in/courses/cpp-programming.html", "provider": {"@type": "EducationalOrganization", "name": "Chedo Tech", "url": "https://chedo.in/"}, "inLanguage": "en", "courseMode": "Offline"}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://chedo.in/"}, {"@type": "ListItem", "position": 2, "name": "Courses", "item": "https://chedo.in/courses.html"}, {"@type": "ListItem", "position": 3, "name": "C++ Programming", "item": "https://chedo.in/courses/cpp-programming.html"}]}</script></head>
  ...
  <div class="relative mx-auto max-w-7xl px-5 pb-16 pt-12 sm:px-8 lg:pb-20 lg:pt-14">
    ...
    <div class="grid items-start gap-10 lg:grid-cols-12">
      <div class="lg:col-span-8">
        ...
        <h1 class="mt-5 text-[clamp(2.2rem,5vw,3.75rem)] font-extrabold leading-[1.06] tracking-tight text-slate-900">C++ Programming</h1>
        <p class="mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Master C++ foundations — OOP, memory management, templates, STL and exception handling.</p>
        <div class="mt-7 flex flex-col gap-3 sm:flex-row">
          <a class="btn-wa" data-wa data-wa-text="Hello Chedo Tech, I am interested in the C++ Programming course. Please share more information." href="../contact.php">
            <!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
...
>
  <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0 1 20 4v10a1 1 0 0 1-.4.8A6 6 0 0 1 16 16c-3 0-5-2-8-2a6 6 0 0 0-4 1.528" />
          ...
          <a class="btn-primary mt-6 w-full" data-wa data-wa-text="Hello Chedo Tech, I am interested in the C++ Programming course. Please share more information." href="../contact.php">Get Course Details</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-2">
    <div>
      ...
      <div class="mt-5 space-y-4"><p class="leading-relaxed text-slate-600">C++ takes you from structured programming into object-oriented programming: classes, objects, abstraction, encapsulation, inheritance and polymorphism — the concepts that power almost every modern codebase.</p><p class="leading-relaxed text-slate-600">This course covers memory and object management, constructor/destructor behaviour, operator and function overloading, templates, the STL containers used in real software, exception handling and permanent file storage — taught offline with live coding and practical programs.</p></div>
    </div>
    <div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Master OOP properly</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Classes, objects, inheritance and polymorphism — taught with working programs, not just definitions.</p></div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Understand memory</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Dynamic allocation, constructors, destructors and the this keyword demystify how objects really work.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Write reusable code</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Function and class templates plus the STL replace repetitive code with generic, efficient solutions.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Handle real-world errors</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">try, catch, throw and standard exceptions make your programs reliable.</p></div>
    </li></ul>
    </div>
  </div>
</section>
...
<details class="acc-item" open>
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">OOPs &amp; Core Concepts</span>
      <span class="block text-xs font-medium text-slate-500">Namespaces, I/O, OOP principles</span>
    </span>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Namespaces</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Organizing code without name clashes</p>
        </div>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Basic I/O</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Console input and output</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Object-Oriented Principles</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Classes, objects, abstraction, encapsulation, inheritance, polymorphism</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Memory &amp; Object Management</span>
      <span class="block text-xs font-medium text-slate-500">Objects, constructors, lifetime</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Dynamic Memory Allocation</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Managing memory at runtime</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Constructors</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Initializing objects correctly</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">this Keyword &amp; Friend Functions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Object access and controlled exposure</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Destructors</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Cleanup and resource release</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Function-Level Tools</span>
      <span class="block text-xs font-medium text-slate-500">Control &amp; efficiency</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Inline Functions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Performance-aware function design</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">static &amp; const</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Scope and immutability</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Scope Resolution Operator (::)</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Namespaced and class-scoped access</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Polymorphism &amp; Overloading</span>
      <span class="block text-xs font-medium text-slate-500">Compile-time &amp; runtime behaviour</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Polymorphism</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Compile-time and runtime polymorphism</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Constructor &amp; Operator Overloading</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Custom types that behave naturally</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Pure Virtual Functions &amp; Overriding</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Abstract contracts and dynamic binding</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Inheritance &amp; Access</span>
      <span class="block text-xs font-medium text-slate-500">Class hierarchies</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Types of Inheritance</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Single, multiple and hierarchical</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Access Modifiers</p>
          <p class="text-[13px] leading-relaxed text-slate-500">public, protected, private</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Constructors in Inheritance</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Initialization across class trees</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Exceptions</span>
      <span class="block text-xs font-medium text-slate-500">Handle runtime errors</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">try, catch, throw</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Catch and manage runtime errors</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Standard Exceptions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">std::exception, std::out_of_range, std::runtime_error</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Templates</span>
      <span class="block text-xs font-medium text-slate-500">Generic programming</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Function Templates</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Type-flexible reusable functions</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Class Templates</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Reusable type-flexible classes</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Reducing Redundancy</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Write once, use with any type</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">STL</span>
      <span class="block text-xs font-medium text-slate-500">Containers for real tasks</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">vector &amp; list</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Sequences and dynamic storage</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">stack &amp; queue</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Scheduling and undo-style tasks</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">set &amp; map</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Unique storage and fast lookup</p>
        </div>
      </li></ul>
  </div>
</details>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Open, Read, Write, Close</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Save and retrieve data permanently</p>
        </div>
      </li></ul>
  </div>
</details></div>
...
<section class="border-t border-slate-100 bg-slate-50/70 py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    ...
    <div class="mt-6 flex flex-wrap gap-2"><span class="chip">OOP Concepts</span><span class="chip">Memory Management</span><span class="chip">Templates &amp; Generic Code</span><span class="chip">STL Containers</span><span class="chip">Exception Handling</span><span class="chip">File I/O</span><span class="chip">Problem Solving</span></div>
  </div>
</section>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">OOP Mini Applications</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Classes, inheritance and polymorphism combined into working console programs.</p>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">STL Data Programs</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">vector, stack, queue, set and map used to organize data for real tasks.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Exception-Safe Programs</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Programs that catch and handle errors instead of crashing.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Data saved to and retrieved from files permanently.</p>
    </div></div>
  </div>
</section>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    <div class="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-6 py-14 text-center sm:px-12 sm:py-16">
      ...
      <div class="relative">
        <h2 class="mx-auto max-w-2xl text-[clamp(1.9rem,4vw,3rem)] font-extrabold leading-tight tracking-tight text-slate-900">Interested in the C++ Programming Course?</h2>
        ...
        <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a class="btn-wa btn-lg" data-wa data-wa-text="Hello Chedo Tech, I am interested in the C++ Programming course. Please share more information." href="../contact.php"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
