...
<head>
  ...
  <meta name="description" content="Learn C programming in Pune at Chedo Tech — offline, practical training from basics to pointers, memory, file handling and mini projects. Absolute beginner friendly.">
  <link rel="canonical" href="https://chedo.in/courses/c-programming.php">
  ...
  <meta property="og:description" content="Learn C programming in Pune at Chedo Tech — offline, practical training from basics to pointers, memory, file handling and mini projects. Absolute beginner friendly.">
  <meta property="og:url" content="https://chedo.in/courses/c-programming.html">
  ...
  <meta name="twitter:description" content="Learn C programming in Pune at Chedo Tech — offline, practical training from basics to pointers, memory, file handling and mini projects. Absolute beginner friendly.">
  <meta name="twitter:image" content="https://chedo.in/assets/images/og-image.png">
  <link rel="preload" href="../assets/fonts/inter-latin.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="stylesheet" href="../assets/css/main.css">
  <script defer src="../assets/js/config.js"></script>
  <script defer src="../assets/js/main.js"></script>
  <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Course", "name": "C Programming", "description": "Learn C programming in Pune at Chedo Tech — offline, practical training from basics to pointers, memory, file handling and mini projects. Absolute beginner friendly.", "url": "https://chedo.in/courses/c-programming.html", "provider": {"@type": "EducationalOrganization", "name": "Chedo Tech", "url": "https://chedo.in/"}, "inLanguage": "en", "courseMode": "Offline"}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://chedo.in/"}, {"@type": "ListItem", "position": 2, "name": "Courses", "item": "https://chedo.in/courses.html"}, {"@type": "ListItem", "position": 3, "name": "C Programming", "item": "https://chedo.in/courses/c-programming.html"}]}</script></head>
  ...
  <div class="relative mx-auto max-w-7xl px-5 pb-16 pt-12 sm:px-8 lg:pb-20 lg:pt-14">
    ...
    <div class="grid items-start gap-10 lg:grid-cols-12">
      <div class="lg:col-span-8">
        ...
        <p class="mt-4 max-w-2xl text-lg leading-relaxed text-slate-600">Build strong logic, core programming &amp; problem-solving skills from zero.</p>
...
<section class="py-16 sm:py-20">
  <div class="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-2">
    <div>
      ...
      <div class="mt-5 space-y-4"><p class="leading-relaxed text-slate-600">C is where serious programming foundations are built. In this course you start from absolute zero — how programs work, how they compile and execute — and progress through control flow, arrays, pointers, memory, functions, recursion and file handling.</p><p class="leading-relaxed text-slate-600">Every topic is taught with live coding on a whiteboard-led, offline classroom format. By the end you will have written a set of small but complete applications, and you will be ready to move into C++, Java or Data Structures & Algorithms.</p></div>
    </div>
    <div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Absolute beginner friendly</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">No prior coding knowledge needed — the course starts from how programs actually work.</p></div>
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Strong logic building</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Pattern programs, logic problems and interview-style practice run through every level.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Foundation for all languages</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">C concepts — memory, pointers, control flow — carry directly into C++, Java, Python and DSA.</p></div>
    </li><li class="flex items-start gap-4 rounded-2xl border border-slate-200/80 bg-white p-5">
      <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  <path d="M20 6 9 17l-5-5" />
      ...
      <div><h3 class="text-[15px] font-bold text-slate-900">Interview-ready practice</h3><p class="mt-1 text-sm leading-relaxed text-slate-500">Debugging, problem solving and mini projects train you to write and fix real code.</p></div>
    </li></ul>
    </div>
  </div>
</section>
...
<details class="acc-item" open>
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Programming Basics</span>
      <span class="block text-xs font-medium text-slate-500">Zero → first code</span>
    </span>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Introduction to Programming</p>
          <p class="text-[13px] leading-relaxed text-slate-500">How programs work, compilation, execution</p>
        </div>
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Data Types &amp; Variables</p>
          <p class="text-[13px] leading-relaxed text-slate-500">int, float, char, constants</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Operators</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Arithmetic, relational, logical</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Input / Output</p>
          <p class="text-[13px] leading-relaxed text-slate-500">scanf, printf &amp; basic programs</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Control Flow + Logic Building</span>
      <span class="block text-xs font-medium text-slate-500">Conditions, loops, patterns</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">if, else, nested conditions</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Loops</p>
          <p class="text-[13px] leading-relaxed text-slate-500">for, while, do-while</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Pattern Programs</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Number &amp; star patterns</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Logic Problems</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Real problem solving practice</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Arrays, Strings &amp; Memory</span>
      <span class="block text-xs font-medium text-slate-500">Data, addresses, pointers</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">1D, 2D arrays &amp; operations</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">String functions &amp; manipulation</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">Memory, address, pointer logic</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Dynamic Memory</p>
          <p class="text-[13px] leading-relaxed text-slate-500">malloc, calloc, free</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Functions &amp; Modular Programming</span>
      <span class="block text-xs font-medium text-slate-500">Divide and conquer</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Functions</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Parameters, return types</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          ...
          <p class="text-[13px] leading-relaxed text-slate-500">Function calling itself</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Modular Code</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Divide programs into parts</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Math Programs</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Factorial, Fibonacci, etc.</p>
        </div>
      </li></ul>
  </div>
</details>
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Advanced C Concepts</span>
      <span class="block text-xs font-medium text-slate-500">Structures, macros, files</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Structures</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Store complex data</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Macros</p>
          <p class="text-[13px] leading-relaxed text-slate-500">#define &amp; preprocessors</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Storage Classes</p>
          <p class="text-[13px] leading-relaxed text-slate-500">auto, static, extern</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
<details class="acc-item" >
  <summary class="acc-summary">
    ...
    <span class="min-w-0">
      <span class="block text-[15px] font-bold tracking-tight text-slate-900">Practical + Industry Foundation</span>
      <span class="block text-xs font-medium text-slate-500">Finish strong</span>
    </span>
    <span class="acc-chevron" aria-hidden="true"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-4 w-4"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Debugging</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Error finding &amp; fixing</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Problem Solving</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Interview-level questions</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Mini Projects</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Real small applications</p>
        </div>
      </li><li class="flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50/60 p-3">
        <span class="mt-0.5 text-blue-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
...
>
  ...
  <circle cx="12" cy="12" r="1" />
        ...
        <div>
          <p class="text-sm font-semibold text-slate-800">Next Step</p>
          <p class="text-[13px] leading-relaxed text-slate-500">Move to C++, Java, DSA</p>
        </div>
      </li></ul>
  </div>
</details></div>
...
<section class="border-t border-slate-100 bg-slate-50/70 py-16 sm:py-20">
  <div class="mx-auto max-w-7xl px-5 sm:px-8">
    ...
    <div class="mt-6 flex flex-wrap gap-2"><span class="chip">Strong Logic Building</span><span class="chip">Problem Solving</span><span class="chip">Memory Understanding</span><span class="chip">Programming Fundamentals</span><span class="chip">Debugging Skills</span><span class="chip">Structured Programming</span></div>
  </div>
</section>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Student Record System</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">A complete small application combining structures, arrays and file handling.</p>
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Calculator App</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Operators, functions and modular design in a working calculator.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">File Manager</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Create, read and update files with the file handling module.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Pattern Generator</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Number and star patterns that sharpen loop and logic skills.</p>
    </div><div class="card card-hover flex flex-col p-5">
      <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600"><!-- @license lucide-static v1.28.0 - ISC -->
<svg aria-hidden="true" focusable="false"
  class="h-5 w-5"
...
>
  <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" />
      ...
      <h3 class="mt-3 text-[15px] font-bold text-slate-900">Logic-Based Programs</h3>
      <p class="mt-1.5 flex-1 text-sm leading-relaxed text-slate-500">Interview-style problems practiced across the whole course.</p>
    </div></div>
  </div>
</section>
