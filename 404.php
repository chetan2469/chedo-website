...
<head>
  ...
  <title>Page Not Found | Chedo Tech</title>
  <meta name="description" content="The page you are looking for could not be found. Explore Chedo Tech's programming courses or return to the homepage.">
  <meta name="robots" content="noindex, follow">
  <link rel="canonical" href="https://chedo.in/404.php">
  <link rel="icon" type="image/svg+xml" href="assets/images/favicon.svg">
  <link rel="apple-touch-icon" href="assets/images/apple-touch-icon.png">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Chedo Tech">
  <meta property="og:title" content="Page Not Found | Chedo Tech">
  <meta property="og:description" content="The page you are looking for could not be found. Explore Chedo Tech's programming courses or return to the homepage.">
  <meta property="og:url" content="https://chedo.in/404.html">
  <meta property="og:image" content="https://chedo.in/assets/images/og-image.png">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Page Not Found | Chedo Tech">
  <meta name="twitter:description" content="The page you are looking for could not be found. Explore Chedo Tech's programming courses or return to the homepage.">
...
<section class="relative flex min-h-[70vh] items-center overflow-hidden py-20">
  ...
  <div class="relative mx-auto max-w-3xl px-5 text-center sm:px-8">
    <div class="terminal mx-auto max-w-md text-left">
      <div class="terminal-bar">
        <span class="win-dot bg-red-400"></span><span class="win-dot bg-amber-400"></span><span class="win-dot bg-emerald-400"></span>
        <span class="ml-2 font-mono text-[11px] text-slate-400">404 — not found</span>
      </div>
      <div class="terminal-body">
<pre><span class="term-prompt">$</span> <span class="text-slate-200">find course</span>
<span class="term-dim">error: page not found</span>
<span class="term-ok">✓</span> <span class="term-dim">hint: check the URL or head home</span></pre>
      </div>
    </div>
    <p class="mt-10 font-mono text-7xl font-black tracking-tight text-slate-200">404</p>
    <h1 class="mt-3 text-[clamp(1.8rem,4vw,2.75rem)] font-extrabold tracking-tight text-slate-900">Looks like this lesson isn't in our curriculum.</h1>
    <p class="mx-auto mt-4 max-w-md text-lg leading-relaxed text-slate-500">The page you're looking for may have moved. Explore our courses or head back home.</p>
    <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
      <a class="btn-primary btn-lg" href="courses.php">Explore Courses</a>
      <a class="btn-secondary btn-lg" href="index.php">Back Home</a>
    </div>
  </div>
</section>
